...
/*
this comparison returns whether or not a's name is before b's name (alphabetically)
*/
...
/*
this comparison returns if they have the same name or not
*/
...
/*
this comparison returns if a's name is before or the same as b's name
*/
